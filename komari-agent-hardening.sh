...
if command -v setcap >/dev/null 2>&1; then
  ...
  echo "未找到 setcap，已跳过 cap_net_raw。"
  echo "如果 ping 功能异常，请安装 libcap2-bin 后重新运行此脚本。"
fi
...
echo "==> 7. 写入 systemd override 加固配置"
...
echo "2. 启动参数包含 --disable-web-ssh"
echo "3. 启动参数包含 --disable-auto-update"
echo
echo "回滚命令："
